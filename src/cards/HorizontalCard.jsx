...
const HorizontalCard = ({ id, name, poster, posterV, genre, plot, trailer, duration, director, stars }) => {
        ...
        <div className='fixed right-[341px] top-[47px] bg-white  text-black rounded-2xl z-20'>
          <div className="w-[664px] h-[540px] shadow-xl border rounded-2xl grid">
            ...
            <div className="flex justify-center items-end pb-6">
              <button className='bg-darkpurple w-[550px] h-[50px] rounded-xl text-white font-semibold text-lg transition-colors duration-100 ease-out hover:bg-purple' onClick={() => window.open(trailer, "_blank")}>Watch Trailer</button>
            </div>
