...
const Popover = ({ name, poster, posterV, genre, plot, trailer, duration, director, stars, onClose }) => {
    ...
    return (
        <>
            ...
            {/* Popover */}
            <div
                className={`absolute bottom-0 left-5 hide-scrollbar transform -translate-x-1/2 bg-white text-black rounded-t-2xl z-20 shadow-lg transition-transform duration-300 ease-in-out ${isClosing ? styles.animateSlideOut : styles.animateSlideIn
                    }`}
                style={{
                    width: "calc(100% - 32px)",
                    height:"650px",
