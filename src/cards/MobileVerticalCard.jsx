...
const Popover = ({ name, poster, posterV, genre, plot, trailer, duration, director, stars, onClose }) => {
    ...
    return (
        <>
            ...
            {/* Popover */}
            <div
                className={`fixed bottom-0 left-5 hide-scrollbar transform -translate-x-1/2 bg-white text-black rounded-t-2xl shadow-lg transition-transform duration-300 ease-in-out ${isClosing ? styles.animateSlideOut : styles.animateSlideIn
                    }`}
                style={{
                    width: "calc(100% - 32px)",
                    maxWidth: "350px",
