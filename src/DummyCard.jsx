...
const DummyCard = ({id,name,poster,posterV,genre,plot,trailer,duration,director,stars}) => {
...
<div className="grid grid-rows-1 z-auto">
    ...
    <div
      ...
      style={{ width: "238px", height: "142px" }}
    >
      {/* Image */}
      <img
        src={poster}
...
const Popover = ({id, name, poster, posterV, genre, plot, trailer, duration, director, stars,   onClose}) => {
  ...
  return (
    ...
    <div className="fixed inset-0 bg-black/30 backdrop-blur-md z-10"></div>
        <div className="">
        <div className='fixed right-[341px] top-[55px] bg-white  rounded-2xl z-20'>
            <div className="w-[664px] h-[540px] shadow-xl border rounded-2xl grid">
                  ...
                  <div className="flex justify-center items-end pb-6">
                    <button className='bg-blue-500 w-[450px] h-[50px] rounded-xl text-white font-semibold text-lg hover:bg-blue-700 transition-colors 500 ease-in-out' onClick={() => window.open(trailer, "_blank")}>Watch Trailer</button> 
                  </div>
